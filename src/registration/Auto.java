...
/**
 * This is the Automobile Vehicle class.
 */
public class Auto extends AbstractVehicle {
  protected static final int MAX_PASSENGERS = 5;
   ...
   */
  public Auto(String kind, String make, int productionYear, double purchasePrice) {
